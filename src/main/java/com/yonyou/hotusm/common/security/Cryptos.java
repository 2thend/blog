 ...
 */
package com.yonyou.hotusm.common.security;
...
public class Cryptos {
	 ...
	 * @param input 原始输入字符�?	 * @param key 密钥
	 */
	 ...
	 * 
	 * @param input 原始输入字符数组
	 * @param key 符合AES要求的密�?	 * @param iv 初始向量
	 */
	 ...
	 * 
	 * @param input 原始字节数组
	 * @param key 符合AES要求的密�?	 * @param mode Cipher.ENCRYPT_MODE �?Cipher.DECRYPT_MODE
	 */
